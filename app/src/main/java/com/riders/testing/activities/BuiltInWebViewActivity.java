...
import com.riders.testing.utils.BrowserUtils;
...
public class BuiltInWebViewActivity extends AppCompatActivity {
    ...
    private static final String TAG = BuiltInWebViewActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_built_in_webview_main);
    ...
    private void initWebView() {
        ...
        mBuiltInWebView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (BrowserUtils.isSameDomain(postUrl, url)) {
                    Intent intent = new Intent(BuiltInWebViewActivity.this, BuiltInWebViewActivity.class);
        ...
        mBuiltInWebView.setOnTouchListener(new View.OnTouchListener() {
    ...
    private void openInAppBrowser(String url) {
        Intent intent = new Intent(BuiltInWebViewActivity.this, BuiltInBrowserActivity.class);
