...
import com.riders.testing.services.BackgroundDetectedActivitiesService;
...
public class ActivityRecognitionActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                if (intent.getAction().equals(Const.BROADCAST_DETECTED_ACTIVITY)) {
    ...
    protected void onResume() {
        ...
        LocalBroadcastManager.getInstance(this).registerReceiver(broadcastReceiver,
                new IntentFilter(Const.BROADCAST_DETECTED_ACTIVITY));
    }
    ...
    private void handleUserActivity(int type, int confidence) {
        ...
        if (confidence > Const.CONFIDENCE) {
