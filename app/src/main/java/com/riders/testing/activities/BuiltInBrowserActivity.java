...
public class BuiltInBrowserActivity extends AppCompatActivity {
    ...
    private static final String TAG = BuiltInBrowserActivity.class.getSimpleName();
    ...
    private void initWebView() {
        ...
        mBrowserWebView.setOnTouchListener(new View.OnTouchListener() {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_bookmark) {
            ...
            String msg = BrowserUtils.isBookmarked(this, mBrowserWebView.getUrl()) ?
