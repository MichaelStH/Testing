...
import com.riders.testing.adapters.ListViewAdapter;
...
public class FilterListViewActivity extends AppCompatActivity {
    ...
    private static final String TAG = FilterListViewActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = (ListView) findViewById(R.id.lv_filter_listview);
        ...
        editsearch = (EditText) findViewById(R.id.et_filter_listview_search);
